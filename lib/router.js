...
// 微末分享
router.get('/share/weimo', require('./routes/share/weimo'));
// 微末分享
router.get('/wuzuowei/index', require('./routes/wuzuowei/index'));
// macFlow
router.get('/macflow/index', require('./routes/macflow/index'));
// 8ym
router.get('/yangmao/8ym', require('./routes/yangmao/8ym'));
// 8ym
// router.get('/52pojie/fuli/:orderBy/:filter', require('./routes/52pojie/fuli'));
